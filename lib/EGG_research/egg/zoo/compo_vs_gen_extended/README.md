...
```bash
python -m egg.zoo.compo_vs_gen_extended.train  --n_values=1 --n_attributes=6 --vocab_size=200 --max_len=2 --batch_size=5120 --sender_cell=lstm --receiver_cell=lstm --random_seed=1
```
