...
do
    ...
    python ../run_recon_game.py --random_seed $s --topo_path ../log/recon_topsim/$s.txt --cuda_no 2

    # run referential game
    python ../run_refer_game.py --random_seed $s --topo_path ../log/refer_topsim/$s.txt --cuda_no 2
done