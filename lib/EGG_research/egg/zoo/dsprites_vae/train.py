...
# LICENSE file in the root directory of this source python -m egg.zoo.dsprites_vae.train --lr=1e-3 --batch_size=128 --n_epochs=100 --vocab_size=2tree.
...
import numpy as np
from archs import Sender, Receiver, VisualReceiver, VisualSender
from egg.zoo.data_loaders.data_loaders import get_dsprites_dataloader, get_dsprites
...
class betaVAE_Game(nn.Module):
    def __init__(self, sender, receiver, z_dim=10, beta=1):
...
def main(params):
    ...
    if False:#opts.dataset == 'mnist':
        ...
        image_shape = (28, 28)
<<<<<<< HEAD
    elif True:#opts.dataset == 'dsprites':
        #train_loader, test_loader = get_dsprites_dataloader(path_to_data='egg/zoo/data_loaders/data/dsprites.npz',
...
=======
        ...
        if not os.path.exists(root):
            ...
            subprocess.call([os.path.join('egg', 'zoo', 'data_loaders', 'download_dsprites.sh')])
            print('Finished')
